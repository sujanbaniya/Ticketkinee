<?php
    ...
    $bus_ticket_no = $_SESSION['bus_ticket_no'];
    ...
    $QR_Data .= "Bus Ticket No: ".$bus_ticket_no . "\n";
    ...
    $sql_insert= "INSERT INTO `booked_bus`(`bb_id`, `bus_ticket_list_id`, `name`, `user_email`, `location`, `destination`, `departure_datetime`, `arrival_datetime`, `status`, `qr_location_local_pc`) VALUES ('[value-1]','$bus_ticket_no','$first_name','$email','$location_from','$destination','$departure_datetime','$arrival_datetime','active','$qr_location_local_pc')";
    ...
    <body>
        <table>
            ...
            <tr>
                <td>
                    <h3 class='text-body'>You have successfully booked the bus ticket for $destination.</h3>
                </td>
            </tr>
            <tr>
                <td>
                    <h3 class='text-body'>The bus details are as follows:</h3>
                </td>
            </tr>
            <tr>
                <td class='text-body-details'>Bus Ticket No.: $bus_ticket_no</td>
            </tr>
            <tr>
    ...
    <body>
        <form action="main_page.php" method="post">
            <div class="project">
                ...
                <div class="edit">
                    <label style="font-size:20px;">Bus Departure Date: <?php echo "<b>".$departure_datetime."</b>";?></label>
                </div>
                <div class="edit">
                    <label style="font-size:20px;">Bus Ticket No: <?php echo "<b>".$bus_ticket_no."</b>";?></label>
                </div>
                <div class="edit">
