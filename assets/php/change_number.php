<?php
    ...
    $user_number = $user_first_name['user_contact_no'];
    ...
    if (isset($_POST["submit"])){
        $user_old_number = $_POST["old_number"];
        $user_new_number = $_POST["new_number"];
        $confirm_user_number = $_POST["confirm_new_number"];
        
        if($user_number != $user_old_number){
                $message[] = 'Current Number Not Matched.';
        }else if($user_new_number != $confirm_user_number){
            $message[] = 'New Number Not Matched.';
        }else{
            $update_data = mysqli_query($conn, "UPDATE `users` SET `user_contact_no`='$confirm_user_number' WHERE `user_id`='$user_id'") or die('query failed');
            $_SESSION['successMessage'] = 'Number Changed Successfully.';
...
<html>
    <head>
        <title>TicketKinee | Change Numer</title>
...
<body>
    ...
    <form action="change_number.php" method="POST">
      ...
      <div class="formcontainer">
        <div class="container">
            <label for="old_number">Enter New Number</label>
            <input type="text" placeholder="Enter Old Number" name="old_number" required>
        </div>
        <div class="container">
            <label for="new_number">Enter New Number</label>
            <input type="text" placeholder="Enter New Number" name="new_number" required>
        </div>
        <div class="container">
            <label for="confirm_new_number">Confirm New Number</label>
            <input type="text" placeholder="Confirm New Number" name="confirm_new_number" required>
        </div>
        <?php
            if(isset($message)){
