...
<header class="header">
        ...
        <a href="../php/main_page.php" class="logo"><img src="../logos/TicketKinee_LogoHorizontal.png" alt="Logo" class="logo"></a>

        <nav class="navbar">
            <a href="bus_main.php">Bus Tickets</a>
            <a href="bus_bookedSeats.php">Booked Seats</a>
        </nav>
