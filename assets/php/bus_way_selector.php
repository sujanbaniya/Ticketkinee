...
<!-- 
    ...
    <!-- header/navbar section ends -->
        ...
        <section class="home review" id="selet_way" style="height:90vh;">

            <h1 class="heading"  style="margin-top:100px;"> Ticket <span>Type</span> </h1>

            <div class="review-slider">
                <div class="box">
                    <div><img style="width:auto; height:auto; border-radius: 0; margin-bottom: 10px;" src="../icons/bus_one_way.jpg" alt=""></div>
                    <h3>One Way Ticket</h3>
                    <a href="bus_oneway_form.php" class="btn">Proceed</a>
                </div>
                <!-- <div class="box">
                    <div><img style="width:auto; height:auto; border-radius: 0; margin-bottom: 10px;"  src="../icons/two-way.png" alt=""></div>
                    <h3>Two Way Ticket</h3>
                    <a href="bus_twoway_form.php" class="btn">Proceed</a>
                </div> -->
            </div>
        </section>
