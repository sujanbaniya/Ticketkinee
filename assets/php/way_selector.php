    ...
    <!-- header/navbar section ends -->
        ...
        <section class="home review" id="selet_way" style="height:90vh;">
            ...
            <div class="review-slider">
                <div class="box">
                    <div><img style="width:auto; height:auto; border-radius: 0; margin-bottom: 10px;" src="../icons/one-way.png" alt=""></div>
                    <h3>One Way Ticket</h3>
                    <a href="oneway_form.php" class="btn">Proceed</a>
                </div>
                <div class="box">
                    ...
                    <a href="twoway_form.php" class="btn">Proceed</a>
                </div>
            </div>
        </section>
