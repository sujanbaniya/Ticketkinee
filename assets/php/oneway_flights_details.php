    ...
    <body>
        ...
        <table>
            ...
            echo " Number of Travellers:".$no_of_travellers."<br><br>";
                ...
                $result = $conn->query("SELECT * FROM flight_lists WHERE location_from='$location_from' AND destination='$destination' AND departure_datetime='$departure_datetime' AND arrival_datetime=''");
