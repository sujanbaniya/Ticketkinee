<?php
    ...
    if (isset($_POST["submit"])){
        ...
        $confirm_firstName = $_POST["confirm_new_firstName"];
        $lastName = $_POST["new_lastName"];
        $confirm_lastName = $_POST["confirm_new_lastName"];
        
        if($firstName != $confirm_firstName){
                $message[] = 'First Name Not Matched.';
        }else if($lastName != $confirm_lastName){
            $message[] = 'Last Name Not Matched.';
        }else{
            $update_data = mysqli_query($conn, "UPDATE `users` SET `user_first_name`='$confirm_firstName', `user_last_name`='$confirm_lastName' WHERE `user_id`='$user_id'") or die('query failed');
            $_SESSION['successMessage'] = 'Name Changed Successfully.';
...
<html>
    <head>
        <title>TicketKinee | Change Name</title>
...
<body>
    ...
    <form action="change_name.php" method="POST">
      ...
      <div class="formcontainer">
        <div class="container">
            <label for="new_firstName">Enter New First Name</label>
            <input type="text" placeholder="Enter New Name" name="new_firstName" required>
        </div>
        <div class="container">
            <label for="new_lastName">Enter New Last Name</label>
            <input type="text" placeholder="Enter New Name" name="new_lastName" required>
        </div>
        <div class="container">
            <label for="confirm_new_firstName">Confirm New First Name</label>
            <input type="text" placeholder="Confirm New First Name" name="confirm_new_firstName" required>
        </div>
        <div class="container">
            <label for="confirm_new_lastName">Confirm New Last Name</label>
            <input type="text" placeholder="Confirm New First Name" name="confirm_new_lastName" required>
        </div>
        <?php
            if(isset($message)){
