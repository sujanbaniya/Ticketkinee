        ...
        <div class="project">
            ...
            <hr>
                ...
                <div class="edit">
                    ...
                    <input type="date" class="form-input" name="date" autocomplete="off" required min="2022-04-03" max="2022-06-22">
                </div>    
                <div class="edit">        
                    <label for="rdate">RETURN DATE</label>
                    <input type="date" class="form-input" name="rdate" autocomplete="off"  required min="2022-04-03" max="2022-06-22">
                </div>
                <div class="edit">
