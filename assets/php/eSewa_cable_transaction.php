<?php
    ...
    $cable_ticket_no = $_POST['cable_car_no'];
    $price = $_POST['price'];
    ...
    $pid= $first_name.$cable_ticket_no.rand(100, 999);   
...
<!DOCTYPE html>
    ...
    <body>
            <div class="project">
                ...
                <div class="edit">
                    <label style="font-size:20px;">Bus No: <?php echo "<b>".$cable_ticket_no."</b>";?></label>
                </div>
                <div class="edit">
                ...
                <form action=<?php echo $epay_url?> method="POST">
                    ...
                    <input value="http://localhost/mainProject_TicketKinee/assets/php/eSewa_cable_success_QR.php?q=su" type="hidden" name="su">
