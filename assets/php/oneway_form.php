...
<body>
        ...
        <div class="project">
            ...
            <hr>
                ...
                <form id="manage" action="oneway_flights_details.php" method="post">
                    <div class="edit">
                ...
                <div class="edit">
                    ...
                    <input type="date" class="form-input" name="date" autocomplete="off" required min="2022-04-11" max="2022-04-15">
                </div>
                <div class="edit">
