...
<!DOCTYPE html>
    ...
    <section class="review" id="selet_way" style="height:auto;">
        <div class="section-container">
            <h1 class="heading"> Cable Car <span>Tickets</span> </h1>
                <div class="review-slider">
                <?php
                    $booked_cable_data = $conn->query("SELECT * FROM `cable_tickets` AS `cable_ticket`
                    ...
                    while($rows_cable_data = $booked_cable_data->fetch_assoc()){
                        ...
                        $cable_ticket_no = $rows_cable_data['cable_car_no'];
                        $cable_departure_datetime = $rows_cable_data['departure_datetime'];
                        $cable_departure_place = $rows_cable_data['location_from'];
