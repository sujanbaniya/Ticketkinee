...
<!DOCTYPE html>
    ...
    <section class="review" id="selet_way" style="height:auto;">
        <div class="section-container">
            <h1 class="heading"> Flight <span>Lists</span> </h1>
                <div class="review-slider">
                    <?php
                        $booked_flight_data = $conn->query("SELECT * FROM `flight_lists` AS `flight_ticket`
                        ...
                        while($rows_flight_data = $booked_flight_data->fetch_assoc()){
                            ...
                            $flight_ticket_no = $rows_flight_data['flight_no'];
