...
<!DOCTYPE html>
    ...
    <section class="review" id="selet_way" style="height:auto;">
        <div class="section-container">
            <h1 class="heading"> Manage <span>Users</span> </h1>
                        ...
                        while($row=$result->fetch_assoc()):
                            ...
                            <div class="box">
                                ...
                                if($user_type_data == 'admin'){
                                    ?>
                                    <button class="blocked-btn" name="na-cancel">Delete</button>
                                    <?php
                                }else{
                                ?>
                                    <a href="delete_user_query.php?userid=<?php echo $row['user_id']?>" class="btn" name="cancel">Delete</a>
                                <?php
                                }
                                ?>
                            </div>
